...
try:                                                                                                                              
    glb_out = os.path.join(data["output_path"], "result.glb")                                                                       
...
"""
    ...
    if frame_files:
        ...
        glb_export = "/tmp/output/result.glb"                                                                                       
        glb_b64 = None
        if os.path.exists(glb_export):                                                                                              
            with open(glb_export, "rb") as f:                                                                                     
                glb_b64 = base64.b64encode(f.read()).decode("utf-8")                                                                
        return {"image_base64": img_b64, "model_base64": glb_b64, "status": "ok", "format": "gif"}                                  
    else:                                                                                                                           
